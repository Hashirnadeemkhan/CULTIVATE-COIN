...
//   return (
//     <div className="relative min-h-screen w-full  lg:w-[1920px]">
...
//         <div className="absolute left-10 top-4 z-10 h-[70px] w-[68px] rounded-full bg-black lg:left-[175px] lg:top-[88px] lg:h-[137px] lg:w-[134px]">
//           <Image
...
//         {/* Main Content */}
//         <div className=" min-h-screen left-0 bg-[url('/herobg.png')] lg:bg-[url('/Vector.png')] flex w-full lg:flex-row   flex-col items-center gap-[19px] px-4 text-center lg:w-auto lg:items-start lg:px-0 lg:text-left 
//          lg:bg-transparent">
